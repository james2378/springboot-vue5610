...
/**
 * 手办商城：(HandOperatedShoppingMall)表实体类
 *
 */
@Setter
@Getter
@Entity(name = "HandOperatedShoppingMall")
public class HandOperatedShoppingMall implements Serializable {

    // HandOperatedShoppingMall编号
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "hand_operated_shopping_mall_id")
    private Integer hand_operated_shopping_mall_id;
